...
namespace Core\_CForm\field\JSColor;
...
/**
 * Class component
 * @package core\CForm\field\JSColor
 */
class component extends _CForm\AField implements _CForm\IField
{
    ...
    public function init()
    {
        ...
        /** @var \Core\_library\vendor\JSColor\component $select2 */
        $select2 = _library\component::connect('JSColor');
