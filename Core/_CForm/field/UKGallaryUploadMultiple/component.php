...
namespace Core\_CForm\field\UKGallaryUploadMultiple;
...
/**
 * Class component
 * @package core\CForm\field\UKGallaryUploadMultiple
 */
class component extends _CForm\AField implements _CForm\IField
{
    ...
    public function init()
    {
        ...
        //html5sortable
        /** @var \Core\_library\vendor\html5sortable\component $html5sortable */
        $UIkitUpload    =   _library\component::connect('html5sortable');
        $UIkitUpload->setCss(self::$controller);
        $UIkitUpload->setJS(self::$controller);
        $data['INIT']           .=   $UIkitUpload->returnInit($data);

        //UIkitUpload
        /** @var \Core\_library\vendor\UIkitUpload\component $UIkitUpload */
        $UIkitUpload    =   _library\component::connect('UIkitUpload');
        $UIkitUpload->setCss(self::$controller);
        $UIkitUpload->setJS(self::$controller);
