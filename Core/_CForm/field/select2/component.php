...
namespace Core\_CForm\field\select2;
...
/**
 * Class component
 * @package core\CForm\field\select2
 */
class component extends _CForm\AField implements _CForm\IField
{
    ...
    public function init()
    {
        ...
        /** @var \Core\_library\vendor\select2\component $select2 */
        $select2 = _library\component::connect('select2');
