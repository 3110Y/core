...
namespace Core\_CForm\viewer\UKEdit;
 ...
 * Class component
 *
 * @package core\CForm\viewer\UKEdit
 */
class component extends _CForm\AViewer implements _CForm\IViewer
{
        ...
        if (empty($this->data)) {
            ...
            foreach ($this->field as $key => $field) {
                ...
                if (isset($field['type'])) {
                    ...
                    $fieldObject = "core\CForm\\field\\{$fieldName}\component";
                    if (class_exists($fieldObject)) {
                        /** @var \Core\_CForm\field\UKInput\component $fieldComponent */
            ...
            if (isset($this->button['rows']) && !empty($this->button['rows'])) {
                foreach ($this->button['rows'] as $key => $button) {
                    if (isset($button['type'])) {
                        ...
                        $buttonObject = "core\CForm\\button\\{$buttonName}\component";
                        if (class_exists($buttonObject)) {
                            /** @var \Core\_CForm\button\UKButton\component $fieldComponent */
