...
namespace Core\_CForm\viewer\UKListing;
 ...
 * Class component
 *
 * @package core\CForm\viewer\UKListing
 */
        ...
        if ($this->totalRows == 0) {
            ...
            foreach ($this->data as $row) {
                ...
                if (isset($this->config['multi'])) {
                    ...
                    $multiObject = "core\CForm\\field\\{$multiName}\component";
                    if (class_exists($multiObject)) {
                        /** @var \Core\_CForm\field\UKActionID\component $multiComponent */
