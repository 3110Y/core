...
namespace core\component\CForm2\viewer\listing;
	...
	public function run()
	{
		...
		for ($i = 0, $iMax = count($this->data); $i < $iMax; $i++) {
			...
			if (
				...
				/** @var \core\component\CForm2\field\actionID\component $fieldComponent */
				$fieldComponent = CForm2\field\actionID\component::class;
			...
			if (
				...
				foreach ($this->viewerConfig['action']['row'] as $action => $value) {
					/** @var \core\component\CForm2\action\dell\component $actionComponent */
