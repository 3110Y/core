...
final class core
{
     ...
     * 1 версия суммы
     * .
     * 7 версия файла ядра или суммы предыдущего
     * 2 версия компонентов или предыдущего
     * 5 версия исправления ошибок или предыдущего
     * 7 версия хотфиксов
     * 4 проаерка суммы всех чисел 1,7257 = 1,21 = 22 = 4
     */
    const VERSION   =   1.745987;
